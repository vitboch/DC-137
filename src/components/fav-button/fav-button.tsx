...
const FavButton: React.FC<{ id: number }> = ({ id }) => {
  ...
  return (
    user && (
      <button className={cls['fav-button']} onClick={handleClick}>
        {isFavorite ? (
          <svg viewBox="0 0 1024 1024" fill="#fff" height="2rem" width="2rem">
          ...
          <svg viewBox="0 0 1024 1024" fill="#fff" height="2em" width="2em">
